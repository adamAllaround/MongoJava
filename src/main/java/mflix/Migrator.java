...
public class Migrator {
     ...
     */
    private static UpdateOneModel<Document> transformDates(Document doc, DateTimeFormatter dateFormat) {
        ...
        try {
            if (lastUpdated != null) {
                return new UpdateOneModel<>(
                        ...
                        Updates.set("lastupdated", LocalDateTime.parse(lastUpdated, dateFormat)));
            }
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@sandbox.nvbzb.mongodb.net";
        ...
        for (Document doc : movies.find(dateStringFilter)) {
            ...
            WriteModel<Document> updateDate = transformDates(doc, datePattern);
            if (updateDate != null) {
