...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
        ...
        try {
            ...
            throw new IncorrectDaoOperation("Cannot do this");
        }
        return comment;
    }
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        try {
            commentCollection.findOneAndUpdate(Filters.eq("_id", commentId), Updates.set("text", text));
        } catch(Exception e) {
            throw new IncorrectDaoOperation("Cannot do this");
        }
    ...
    public List<Critic> mostActiveCommenters() {
        ...
        List<Bson> bsons = Arrays.asList(group("$email", sum("count", 1L)), sort(Sorts.descending("count")), limit(20));
    ...
    private Critic toCritic(Document document) {
        return new Critic(document.getString("_id"), document.getLong("count").intValue());
    }
}
